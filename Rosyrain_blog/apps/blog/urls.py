...
from .views import IndexView, ArchiveView, TagView, TagDetailView, \
    BlogDetailView, AddCommentView, CategoryDetailView,MySearchView,CategoryView
...
urlpatterns = [
    ...
    re_path(r'^category/$', CategoryView.as_view(), name='cate'),  # 分类云界面
    ...
    re_path(r'^category/(?P<category_name>\w+)/$', CategoryDetailView.as_view(), name='category_name'),  # 具体分类页，包含该分类的博客
    re_path('^search/',MySearchView(),name='haystack_search'),
